...
dagshub.init(repo_owner='sfgrahman', repo_name='mlflow_experiment_dagshub', mlflow=True)


mlflow.set_experiment("water_exp2")

mlflow.set_tracking_uri("https://dagshub.com/sfgrahman/mlflow_experiment_dagshub.mlflow")
